(ns marketentry.facts
  ...
  - `investment-act-spec-basis` grounds this vertical's FLAGSHIP check
    ...
    catalog models completely: (1) sixteen named business activities
