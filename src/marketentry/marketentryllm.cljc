(ns marketentry.marketentryllm
  ...
  the Liberia (LBR) public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "foreign-company?=" (:foreign-company? e)
                        " business-activity=" (:business-activity e)
                        " liberian-partner-share-pct=" (:liberian-partner-share-pct e)
                        " capital-invested-usd=" (:capital-invested-usd e)
                        " tin-record-verified?=" (:tin-record-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-tin-record? e))
                              (:tin-record-verified? e)))
                   0.9 0.3)}))
