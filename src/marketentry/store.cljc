(ns marketentry.store
  "SSoT for the Liberia (LBR) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:foreign-company?` / `:business-activity` / `:liberian-partner-
  share-pct` / `:capital-invested-usd` are ground truth for the
  `foreign-ownership-ineligible-claim?` flagship check (Investment Act
  of 2010, Schedule); `:requires-tin-record?` / `:tin-record-verified?`
  are ground truth for the conditional Liberia Revenue Authority (LRA)
  TIN-record check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Monrovia Fabrication Ltd" :portal "ppcc.gov.lr/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-company? false :business-activity nil
             :liberian-partner-share-pct nil :capital-invested-usd 0.0
             :requires-tin-record? true :tin-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "LBR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "ppcc.gov.lr/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-company? false :business-activity nil
             :liberian-partner-share-pct nil :capital-invested-usd 0.0
    ...
    "eng-3" {:id "eng-3" :operator "Sinkor Systems Ltd" :portal "ppcc.gov.lr/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "LBR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Buchanan Bottling Investments" :portal "ppcc.gov.lr/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-company? true :business-activity :water-purification-or-bottling-plant
             :liberian-partner-share-pct 0 :capital-invested-usd 120000.0
             :requires-tin-record? true :tin-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "LBR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Paynesville Logistics Ltd" :portal "ppcc.gov.lr/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-company? false :business-activity nil
             :liberian-partner-share-pct nil :capital-invested-usd 0.0
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               foreign-company? business-activity liberian-partner-share-pct capital-invested-usd
  ...
  (cond-> {:engagement/id id}
    ...
    (some? foreign-company?)              (assoc :engagement/foreign-company? foreign-company?)
    business-activity                     (assoc :engagement/business-activity business-activity)
    (some? liberian-partner-share-pct)    (assoc :engagement/liberian-partner-share-pct liberian-partner-share-pct)
    (some? capital-invested-usd)          (assoc :engagement/capital-invested-usd capital-invested-usd)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/foreign-company? :engagement/business-activity :engagement/liberian-partner-share-pct
   :engagement/capital-invested-usd
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :foreign-company? (boolean (:engagement/foreign-company? m))
     :business-activity (:engagement/business-activity m)
     :liberian-partner-share-pct (:engagement/liberian-partner-share-pct m)
     :capital-invested-usd (:engagement/capital-invested-usd m)
