...
Portal: Public Procurement and Concessions Commission (PPCC,
ppcc.gov.lr) -- Vendor Registry Division registration is a
qualification precondition for bidding at all (Section 32(1)(b) of the
current Act). Entity: Liberia Business Registry (LBR, an autonomous
agency -- not to be confused with this repo's own ISO3 code) business/
company registration + Liberia Revenue Authority (LRA) Taxpayer
